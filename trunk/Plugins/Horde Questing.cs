...
namespace Horde_Questing
{
    public class Horde_Questing : HBPlugin
    {
        #region Required stuff
        public override string Author
        {
            get { return "People From Buddy Forum"; }
        }
        public override string Name
        {
            get { return "Horde Questing"; }
        }
	...
	static public bool Obj3Done10162 { get { return Lua.GetReturnVal<int>("a,b,c=GetQuestLogLeaderBoard(3,GetQuestLogIndexByID(10162));if c==1 then return 1 else return 0 end", 0) == 1; } }
	    ...
	    #endregion
            #region Quest 10813
            if (Me.QuestLog.GetQuestById(10813) != null && !Me.QuestLog.GetQuestById(10813).IsCompleted)
            {
		Logging.Write("ANSWER ME");
        while(Me.CurrentTarget.Entry == 19440 && Me.CurrentTarget.Distance < 30);
                {
		    Logging.Write("ANSWER ME");
		    WoWMovement.MoveStop();
